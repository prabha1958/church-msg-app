    ...
    return (
        <SafeAreaView className="flex-1 bg-[#040c1f]">
            <ScrollView>
                ...
                <Pressable
                    onPress={() => router.push(`/admin/clergy/edit/${data?.id}`)}
                    className="bg-blue-600  px-4 py-5 rounded-lg mt-4"
                >
                    <Text className="text-white text-xl font-semibold text-center">Edit</Text>
                </Pressable>
            </ScrollView>
        </SafeAreaView>
    );
